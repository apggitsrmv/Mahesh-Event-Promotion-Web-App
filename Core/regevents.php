...
<head>
    ...
    <style>
        body {
            background-color: #fce8da; /* Light peach background */
        }
        ...
        h3 {
            color: #ff4081; /* Pink heading color */
        }

        label {
            color: #ff4081; /* Pink label color */
        }

        .form-control {
            border-color: #ff4081; /* Pink border color */
        }

        .btn-dark {
            background-color: #ff4081; /* Pink button background color */
            border-color: #ff4081; /* Pink button border color */
        }

        /* Party theme styles */
        body {
            background-image: url('path/to/party-background.jpg'); /* Replace with your party-themed image */
            background-size: cover;
            background-repeat: no-repeat;
            background-attachment: fixed;
            color: #fff; /* White text on a party background */
        }

        /* Add more party-themed styles as needed */
    </style>
