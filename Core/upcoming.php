...
<html lang="en">
    <head>
        ...
        <title>eventy | Upcoming Events</title>
    </head>
    <body>
        <header>
        ...
        <main>
                        ...
                        <div class="d-flex align-items-center" style="gap: 15px;">
                            ...
                            <div id="sorting">
                                <select name="sort" id="sort">
                                    <option value="events.date">Date</option>
                                    <option value="events.title">Event Title</option>
                                    <option value="artists.artist_name">Artist Name</option>
                                    <option value="events.category">Category</option>
                            </select>
                            </div>
                        </div>
                    </div>
                ...
                <div class="events my-5">
                    <div class="container">
                    <div class="row result" style="row-gap:40px;">
                    <?php
